...
class ProductItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_item" do
    assert_difference('ProductItem.count') do
      post product_items_url, params: { product_item: { material_id: @product_item.material_id, num: @product_item.num, product_id: @product_item.product_id } }
    end
  ...
  test "should update product_item" do
    patch product_item_url(@product_item), params: { product_item: { material_id: @product_item.material_id, num: @product_item.num, product_id: @product_item.product_id } }
